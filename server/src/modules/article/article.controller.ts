import { Controller, Get, Post, Headers, Body, Query, UsePipes, Delete, Param, Put, UseInterceptors } from '@nestjs/common';
...
export class ArticleController {
   ...
   * */
  @AuthStrategy()
  @UsePipes(new ValidateToEmptyPipe(['id', 'title', 'content', 'introduction', 'original']))
  @Put()
